...
export const GetActiveVehicleList = (data, successCallback) => {
  ...
  return async dispatch => {
    try {
      const response = await fetch(`${GetActiveVehicleListByCompanyId}?companyid=${data}`);
...
export const InsertUpdateDayWiseVehicleRoutes = (data, successCallback) => {
  return async dispatch => {
    ...
    try{
      const response = await store(`${InsertUpdateDayWiseVehicleRoute}`, formData);
      if (response?.status === 200) {
        successCallback(response?.data)
      } else
        successCallback([])
...
export const GetVehicleDetailsByyVId = (data, successCallback) => {
  return async dispatch => {
    try{
      const response = await fetch(`${GetVehicleDetailsByVId}?vehicleId=${data}`);
      if (response?.status === 200) {
        successCallback(response?.data)
      } else
        successCallback([])
...
export const GetStaffDetailsByVehicleIdd = (data, successCallback) => {
  return async dispatch => {
    try{
      const response = await fetch(`${GetStaffDetailsByVehicleId}?vehicleId=${data}`);
      if (response?.status === 200) {
        successCallback(response?.data)
      } else
        successCallback([])
...
export const GetRouteDetailsByDateWisee = (data, successCallback) => {
  return async dispatch => {
    try{
      const response = await fetch(`${GetRouteDetailsByDateWise}?routeday=${data}`);
      if (response?.status === 200) {
        successCallback(response?.data)
      } else{
        successCallback([])
...
export const GetVehicleRouteDetailsByyReceiptId = (data, successCallback) => {
  return async dispatch => {
    try{
      const response = await fetch(`${GetVehicleRouteDetailsByReceiptId}?receiptId=${data}`);
      if (response?.status === 200) {
        successCallback(response?.data)
      } else{
        successCallback([])
...
export const CancelAssignedRouteOfVehicle = (data, successCallback) => {
  return async dispatch => {
    try{
      const response = await store (`${CancelAssignedRouteOfVehicleByAdmin}?vehicleid=${data.vehicleid}&receiptid=${data.receiptid}&remarks=${data.remarks}`);
      if(response?.status === 200){
        successCallback(response?.data)
      }else{
        successCallback([])
